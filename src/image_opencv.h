...
image DrawLine_New(image a, int x1, int y1, int x2,int y2,float r,float g,float b);
// IplImage - to delete
...
// Draw Detection
void draw_box_new_demo(mat_cv* mat, float x, float y,float w,float h,float theta, float r, float g, float b);
